...
public class RoleController {
    ...
    public ResponseBean<RoleVO> edit(@PathVariable String id) throws SystemException {
    ...
    public ResponseBean update(@PathVariable String id, @RequestBody @Validated RoleVO roleVO) throws SystemException {
    ...
    public ResponseBean updateStatus(@PathVariable String id, @PathVariable Boolean status) throws SystemException {
    ...
    public ResponseBean authority(@PathVariable String id, @RequestBody String[] mids) throws SystemException {
    ...
    public ResponseBean<Map<String, Object>> findRoleMenu(@PathVariable String id) throws SystemException {
        List<MenuNodeVO> tree = menuService.findMenuTree();
        //角色拥有的菜单id
        List<String> mids = roleService.findMenuIdsByRoleId(id);
